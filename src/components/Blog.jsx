      ...
      <section className="container mx-auto py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            <Card
              image="/assets/jakub-dziubak-iOHJKJqO6E0-unsplash.jpg"
              text="Foodie's Guide to Global Cuisine"
            />
            <Card
              image="/assets/fabian-blank-pElSkGRA2NU-unsplash.jpg"
              text="How to Travel on a Budget?"
            />
            <Card
              image="/assets/suhyeon-choi-m4uUDTrcJeY-unsplash.jpg"
              text="The Ultimate Guide to Solo Travel"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form className="flex">
            ...
            <input
              ...
              className="w-full py-2 px-4 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500"
