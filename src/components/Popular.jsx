            ...
            <section className="py-12 bg-gray-100">
                <div className="container mx-auto">
                    ...
                    <div className="flex overflow-x-auto">
                        <Card image="/assets/vojtech-bruzek-Yrxr3bsPdS0-unsplash.jpg" text="Mountain View Inn" location=" Aspen, Colorado, USA" ratings="4.9 (2k Reviews)" price="$500 per night"/>
                        <Card image="/assets/upgraded-points-c8UktkMDrbc-unsplash.jpg" text="Sunset Paradise Hotel" location=" Santorini, Greece" ratings="5 (2.9k Reviews)" price="$350 per night"/>
                        <Card image="/assets/yosuke-ota-0R1GMsc2E7w-unsplash.jpg" text="Riverside Retreat Hotel" location="Kyoto, Japan" ratings="4.8 (2k Reviews)" price="$250 per night"/>
                        <Card image="/assets/man-pan-KTSYy-3XVSo-unsplash.jpg" text="Golden Sands Resort" location="Cancun, Mexico" ratings="4.7 (3.2k Reviews)" price="$300 per night"/>
                    </div>
                </div>
            </section>
